...
<main id="primary" class="site-main">
	...
	<ul class="event-list upcoming-events">
		<?php foreach ( railster_event_lines( 'railster_upcoming_events', "18 September - at Parco di Sant'Osvaldo, for La Stagione di Cas*Aupa, 18:00, free entry (UD)" ) as $event ) : ?>
	...
	<ul class="event-list previous-events">
		<?php foreach ( railster_event_lines( 'railster_previous_events', "25 August - at Visionario, with Sleeping Pills (for UdinElettronica) (UD)\n13 July at Visionario (UD)\n29 March at Monsieur D (PN)\n16 April at Tarantola Lib. (UD)\n25 April at KK (UD)\n06 May at Tarantola Lib. for MattiaC (UD)\n24 May at Kaleidoscienza, 22:30 (UD)\n07 June at Mamm (UD)\n15 June at Terminal Festival (UD)" ) as $event ) : ?>
			<li><?php echo esc_html( $event ); ?></li>
		<?php endforeach; ?>
	</ul>
	</div>
